//aqui se crean las variables de boy, path, los tesoros y sus grupos
...
//aqui se añaden las imagenes de boy, path y los tesoros al codigo
function preload(){
...
function draw() {
  ...
  //aqui se crean los bordes y que boy colisione con ellos
  ...
  //aqui se crean los tesoros, y los puntos que le dan a boy al obtenerlos
    createCash();
    createDiamonds();
    createjewelry();
    createSword();
    ...
    if (cashG.isTouching(boy)) {
      ...
      //esto es lo que pasa cuando boy toca las espadas (se acaba el juego)
...
//aqui se crean los sprites de los tesoros, imagen, ubicacion, velocidad, tamaño, lifetime y el codigo para hacer que aparezcan aleatoriamente
function createCash() {
